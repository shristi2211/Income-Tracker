...
export default function TopBar({ onMenuClick, onQuickAdd }) {
  ...
  return (
    <header className="h-16 bg-[#0d1117] border-b border-slate-800/60 flex items-center justify-between px-6 z-30 flex-shrink-0">
      {/* Left */}
      ...
      <div className="flex items-center gap-2.5">
        <button
          onClick={onQuickAdd}
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold transition-all shadow-md shadow-emerald-900/20"
        >
          <Plus size={14} />
        ...
        <div className="hidden md:flex items-center gap-2.5 ml-1 pl-3 border-l border-slate-800">
